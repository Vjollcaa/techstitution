   /*function tryConsole() { 
    ...
    showName("Arta","studente"); 

    $(document).ready(function(){
        console.log("DOM is ready!");
        $('#border-wait-form').submit(function(event) { */
            var dataTimeNow = new Date();
            $('#updatedAt').val(dataTimeNow);
            var dateTimeNow = $('#datetime-now').val(); /*
            event.preventDefault(); //Ndalon ekzekutimin e POST edhe GET
            
            var pikaKufitare = $('#pika-kufitare').val();//marrim vleren e inputit
            ...
            //console.log("Pika Kufitare:" + pikaKufitare + '/n' + "Hyrje min:" + hyrjeMinMinuta + '/n' + "Hyrje min:" + hyrjeMaxMinuta + '/n' + "Dalje min:" + daljeMinMinuta + '/n' + "Dalje min:" + daljeMaxMinuta + '/n' + "Hyrje metra:" + hyrjeMinMetra + '/n' + "Hyrje metra:" + hyrjeMaxMetra + '/n' + "Dalje metra:" + daljeMinMetra + '/n' + "Dalje metra:" + daljeMaxMetra );
        });
    });  
    */